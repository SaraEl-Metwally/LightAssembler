...
#### System requirements 
64-bit machine with g++ compiler or gcc in general. Also, LightAssembler depends on [pthreads](http://en.wikipedia.org/wiki/POSIX_Threads) and [zlib](http://en.wikipedia.org/wiki/Zlib) libraries.
